(function () {
    ...
    function publisherDialogController($scope, $q,
        ...
        else if (vm.entity.serverAlias !== undefined) {
            vm.pickServer = false;
            prepPromises.push(uSyncPublishService.getServer(vm.entity.serverAlias)
        ...
        function loadActions() {
            ...
            var udi = vm.content.udi;
            if (udi === undefined) {
                udi = makeUdi(vm.isMedia ? 'media' : 'document');
            }
